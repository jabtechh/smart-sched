...
export default function CreateTaskComponent() {
  ...
  mutation.mutate({ title: ..., description: ..., dueDate: ..., estimatedDuration: ..., priority: ..., });
...
export default function UpdateTaskComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ id: ..., title: ..., description: ..., dueDate: ..., estimatedDuration: ..., priority: ..., completedAt: ..., });
